...
\usepackage{amssymb}
\usepackage{t1enc}
\usepackage[letterpaper, left=3.5cm, right=2cm, top=2cm, bottom=2cm]{geometry} 
\usepackage{amsmath}
\usepackage{color}
...
\begin{titlepage}
	...
	\parbox{14cm}{\vspace{1cm} 
	    ...
	    {\fontsize{16}{20} \textbf{``Sistema para el monitoreo de la producción de corriente eléctrica de paneles fotovoltaicos por medio de una aplicación móvil.''}}\vspace{1cm}\\
	    {\fontsize{14}{20} \textit{2018-B102}}\vspace{1cm}\\
	    {\fontsize{14}{20} \textit{Presentan}}\\
	    {\fontsize{14}{20} \textbf{Caballero Huesca Carlos Eduardo \\ Gonzalez Ambriz Luis Angel }}\vspace{2.5cm}\\
	    {\fontsize{14}{20} \textit{Directores}}\\
	    {\fontsize{14}{20} \textbf{Cervantes de Anda Ismael \\ Rangel González Josué}}   \vspace{3cm}
	    \end{center}

	       \hfill   \fontsize{14}{20}  \textbf{Noviembre 2018} 
...
\cfinput{archivosTex/estadoArte}

%------------------------------------------------------------------------------------------------------------------------------------
%\chapter{Marco Teórico}

\cfinput{archivosTex/viabilidad}

%------------------------------------------------------------------------------------------------------------------------------------



%%\chapter{Protocolos criptográficos para evitar duplicados}

\cfinput{archivosTex/analisisSistema}
...
%\cfinput{archivosTex/desarrollo}
...
%\include{archivosTex/requerimientos}
%\include{archivosTex/adv-clasificadores}
%\include{archivosTex/propuesta}
%\include{archivosTex/desarrollo}
%\include{archivosTex/conclusiones2}
%\include{archivosTex/anexos}
